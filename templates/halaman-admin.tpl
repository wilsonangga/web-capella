        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="edit_action.php" method="post" target="frame_action30" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action30" id="frame_action30" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action30" id="frame_action30" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action31">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action31" id="frame_action31" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action31" id="frame_action31" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="add_action.php" method="post" target="frame_action21" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action21" id="frame_action21" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action21" id="frame_action21" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="edit_action.php" method="post" target="frame_action22" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action22" id="frame_action22" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action22" id="frame_action22" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action23">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action23" id="frame_action23" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action23" id="frame_action23" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="add_action.php" method="post" target="frame_action27" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action27" id="frame_action27" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action27" id="frame_action27" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="edit_action.php" method="post" target="frame_action28" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action28" id="frame_action28" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action28" id="frame_action28" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action29">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action29" id="frame_action29" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action29" id="frame_action29" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="add_action.php" method="post" target="frame_action24" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action24" id="frame_action24" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action24" id="frame_action24" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="edit_action.php" method="post" target="frame_action25" enctype="multipart/form-data">
                    ...
                    {assign var="viewFrame" value=0}
                        {if $viewFrame eq 1} 
                            <iframe name="frame_action25" id="frame_action25" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                        {else}
                            <iframe name="frame_action25" id="frame_action25" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                        {/if}
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action26">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action26" id="frame_action26" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action26" id="frame_action26" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action" id="frame_action" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action" id="frame_action" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <form action="edit_action.php" target="frame_action2" method="post" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            ...
                            {else}
                                <iframe name="frame_action2" id="frame_action2" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action3">
                        ...
                        {assign var="viewFrame" value=0}
                            ...
                            {else}
                                <iframe name="frame_action3" id="frame_action3" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action7" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action7" id="frame_action7" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action7" id="frame_action7" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action8" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action8" id="frame_action8" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action8" id="frame_action8" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action9">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action9" id="frame_action9" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action9" id="frame_action9" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action39" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action39" id="frame_action39" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action39" id="frame_action39" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action41" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action41" id="frame_action41" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action41" id="frame_action41" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action40">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action40" id="frame_action40" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action40" id="frame_action40" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action36" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action36" id="frame_action36" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action36" id="frame_action36" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action37" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action37" id="frame_action37" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action37" id="frame_action37" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action38">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action38" id="frame_action38" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action38" id="frame_action38" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action45" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action45" id="frame_action45" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action45" id="frame_action45" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action46" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action46" id="frame_action46" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action46" id="frame_action46" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action42" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action42" id="frame_action42" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action42" id="frame_action42" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action44" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action44" id="frame_action44" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action44" id="frame_action44" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action47">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action47" id="frame_action47" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action47" id="frame_action47" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action43">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action43" id="frame_action43" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action43" id="frame_action43" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action18" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action18" id="frame_action18" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action18" id="frame_action18" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action19" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action19" id="frame_action19" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action19" id="frame_action19" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action20">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action20" id="frame_action20" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action20" id="frame_action20" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action10" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action10" id="frame_action10" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action10" id="frame_action10" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="edit_action.php" method="post" target="frame_action11" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action11" id="frame_action11" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action11" id="frame_action11" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action12">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action12" id="frame_action12" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action12" id="frame_action12" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="add_action.php" method="post" target="frame_action13" enctype="multipart/form-data">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action13" id="frame_action13" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action13" id="frame_action13" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="delete.php" method="post" target="frame_action15">
                        ...
                        {assign var="viewFrame" value=0}
                            {if $viewFrame eq 1} 
                                <iframe name="frame_action15" id="frame_action15" src="{$_url}kosong.php" width="100%" height="300" style="overflow:;border:1px red solid;" visibility="visible" scrolling="yes" frameborder="1"></iframe>
                            {else}
                                <iframe name="frame_action15" id="frame_action15" src="{$_url}kosong.php" width="100%" height="10" style="overflow:hidden;display: none;" scrolling="no" frameborder="0"></iframe>
                            {/if}
                    </form>
                </div>
            </div>
